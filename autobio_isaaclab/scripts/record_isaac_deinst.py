#!/usr/bin/env python3
"""Render Isaac Sim static scene from de-instanced Newton USD.

Usage:
    cd autobio-review/AutoBio/autobio_isaaclab
    LD_PRELOAD=/usr/lib/x86_64-linux-gnu/libstdc++.so.6 \
    conda run -n isaac5 --cwd . python scripts/record_isaac_deinst.py --task pickup
"""
import os
...
def main():
    ...
    if args.task:
        ...
        summary_path = DEMO_DIR / "isaac_summary.json"
